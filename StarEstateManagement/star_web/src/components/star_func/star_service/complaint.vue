<template>
  <div>
      ...
      <template slot-scope="props">
        <el-form label-position="right" inline class="demo-table-expand" >
          <el-form-item label="评价人：">
            <span>{{ props.row.appraiser }}</span>
          </el-form-item>
          <el-form-item label="受理人：" style="margin-left: 126px">
          ...
          <el-form-item label="受理时间：">
            <span>{{ props.row.processing_time }}</span>
          </el-form-item>
          <el-form-item label="电话：" style="margin-left: 114px">
            <span>{{ props.row.phone }}</span>
          </el-form-item>
          <el-form-item label="评价任务：">
    ...
    >
      ...
      <template slot-scope="props">
        <form-dialog dialog_title="回复用户"></form-dialog>
        <el-button
          size="mini"
          type="danger"
           ...
           tableData: [
             {
                ...
                message:'',
                status: 0,
                processing_time: '2021-09-21 08:01',
