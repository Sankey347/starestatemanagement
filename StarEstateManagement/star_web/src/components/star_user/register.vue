<template>
    <div class="box">
        <h1 style="margin: 50px 0 10px;">REGISTER</h1>
        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="padding-right: 20px">
          ...
          <el-form-item  prop="checkPass">
            ...
            <el-input  type="text" v-model="ruleForm.checkPass" autocomplete="off" style="display: inline" placeholder="PHONE"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button style="float: left" type="primary" @click="submitForm('ruleForm')">注册</el-button>
            <router-link to="/user" style="float: right">已有账号登录？</router-link>
          </el-form-item>
        </el-form>
      </div>
</template>
